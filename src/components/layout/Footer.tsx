...
export default function Footer() {
  return <footer className="fokal-footer">
    <div className="footer-grid">
      ...
      <div><h4>QUICK LINKS</h4><Link to="/">Home</Link><Link to="/about">About Us</Link><Link to="/services">Services</Link><Link to="/gallery">Our Work</Link><Link to="/clients">Clients</Link></div>
