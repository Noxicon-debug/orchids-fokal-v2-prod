...
export default function HoverReceiver() {
  ...
  // No longer blocking navigation in visual edit mode
  useEffect(() => {
    // We only block clicks if they are specifically on editable elements during active edit
    // but the general navigation should remain possible if not currently editing text
  }, [isVisualEditMode]);
